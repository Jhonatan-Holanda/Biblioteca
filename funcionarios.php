          ...
          <div class="row">
            <table class="t">
              ...
              while($dados = mysqli_fetch_assoc($query)){
                echo "<tr>";
                  echo "<td>";
                      echo "<img class='img-rounded img-responsive imagem' src='fotoPerfil/".$dados['imagem_Funcionario']."'/>";
                  echo "</td>";

                  echo "<td>";
                      echo "<h4>".$dados['nome_Funcionario']."</h4>";
                      echo "<small style='font-size:14px'><cite title='Telefone Contato'>Email: ".$dados['email_Funcionario']."</cite></small><br>";
                      echo " <small style='font-size:12px'><cite title='Telefone Contato'>Telefone: ".$dados['telefone_Funcionario']."</cite></small><br><br>";
                      echo "
                        <a href='editar_funcionario.php?prod_id=".$dados['id_Funcionario']."'>
                        <button type='submit' class='btn btn-primary'>
                          <i class='fa fa-edit'></i> Editar
                        </button>";
                      echo "<a href='remover-funcionario.php?prod_id=".$dados['id_Funcionario']."'>

    ...
    <div class="content-wrapper">
      <div class="container-fluid">
        <div class="card card-register m">
          <div class="card-header n"><center>Cadastramento de Livros</center></div>
              ...
              <div class="form-group">
                <div class="form-row">
                  <div class="col-md-12">
                    ...
                    <input class="form-control" id="exampleInputName" type="text" name="nome_Livro" aria-describedby="nameHelp" placeholder="Nome do Livro">
                  </div>
                </div>
              </div>
              <div class="form-group">
                <label for="exampleInputName">Gênero</label>
                <input class="form-control" id="exampleInputName" type="text"  name="genero_Livro" aria-describedby="nameHelp" placeholder="Gênero">
              </div>
              <div class="form-group">
                <div class="form-row">
                  <div class="col-md-12">
                    <label for="exampleInputName">Autor da Obra</label>
                    <input class="form-control" id="exampleInputName" type="text" name="autor_Livro" placeholder="Autor da Obra">
                  </div>
                </div>
              </div>
              <div class="form-group">
                <div class="form-row">
                  <div class="col-md-12">
                      <img class="img-responsive" src="fotos/<?php echo $img?>" width="80">
                      <label>Carregar Capa do Livro</label>
